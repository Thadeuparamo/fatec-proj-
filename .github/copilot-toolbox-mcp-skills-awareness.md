...
_Generated: 2026-04-27T00:13:29.584Z_
...
Workspace `mcp.json` _(folder: trabalho fatec)_

- **c:\Users\paimn\Desktop\trabalho fatec\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\paimn\AppData\Roaming\Code\User\mcp.json** — _File missing_
